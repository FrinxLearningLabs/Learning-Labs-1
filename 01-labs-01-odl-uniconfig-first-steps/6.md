...
[>>> Next, head for step 7: Execute & Read API call to show interface counters details <<<](Learning-Labs/frinx-learning-labs/labs/01-labs-01-odl-uniconfig-first-steps/7.md)
