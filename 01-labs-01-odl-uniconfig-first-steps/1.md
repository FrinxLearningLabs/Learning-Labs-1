...
* Have an ISO XE network device available that you can connect to and configure during the course of this lab

For further information go to the document [Installation and configuration guide](byod.html)
